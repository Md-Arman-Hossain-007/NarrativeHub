...
LOCAL_APPS = ["core_apps.profiles", "core_apps.common", "core_apps.users", "core_apps.articles",
              "core_apps.ratings"]
...
ROOT_URLCONF = "biographer_api.urls"
...
WSGI_APPLICATION = "biographer_api.wsgi.application"
...
# setup password hash using argon2 configuration
PASSWORD_HASHERS = [
